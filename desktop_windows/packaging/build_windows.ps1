...
Remove-ProjectPath "desktop_windows\build\datadiagnostics"
Remove-ProjectPath "desktop_windows\dist\DataDiagnostics"
...
& $Python -m PyInstaller `
    ...
    desktop_windows\packaging\datadiagnostics.spec

$ExePath = Join-Path $DesktopRoot "dist\DataDiagnostics\DataDiagnostics.exe"
...
Write-Host "Run it with: desktop_windows\dist\DataDiagnostics\DataDiagnostics.exe"
